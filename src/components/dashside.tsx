...
export default function Dashside() {
    return (
        <main>
            <nav className="bg-white min-w-[250px] py-6 px-4 font-[sans-serif] ">
                ...
                <div className="mt-6">
                    <h6 className="text-slate-300 text-sm px-4">Main Menu</h6>
                    <ul className="mt-3">
                        <li>
                        <Link href="javascript:void(0)"
                            className="text-slate-400 hover:text-white text-sm flex items-center hover:bg-blue-600 rounded-md px-4 py-3 transition-all">
                ...
                <div className="mt-6">
                    <h6 className="text-slate-300 text-sm px-4">PREFERENCES</h6>
                    <ul className="mt-3">
                        <li>
                            <Link href="javascript:void(0)"
                                className="text-slate-400 hover:text-white text-sm flex items-center hover:bg-blue-600 rounded-md px-4 py-3 transition-all">
